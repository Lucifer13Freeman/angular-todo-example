...
export class TasksService {
    ...
    public getSortedTasksByCreatedDate(date: string, sort: OrderBy = OrderBy.ASC): Task[] {
        const tasks: Task[] = this.getTasksFromStorage(date).tasks;
        
        const sortedTasks: Task[] = sort === OrderBy.DESC 
    ...
    public getSortedTodosByCompleted(date: string, sort: OrderBy = OrderBy.ASC): Task[] {
        const tasks: Task[] = this.getTasksFromStorage(date).tasks;
    ...
    public setSortedTodosToDefault(date: string): Task[] {
        const tasks: Task[] = this.getTasksFromStorage(date).tasks;
